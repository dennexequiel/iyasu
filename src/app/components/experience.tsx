    ...
    <section className='relative py-16 overflow-hidden w-full bg-white' id='experience'>
      <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='flex flex-col items-center text-center max-w-3xl mx-auto px-6 sm:px-8 lg:px-16'>
          <h1 className='text-3xl leading-tight sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight font-bold text-teal-500 mb-8 sm:mb-10 lg:mb-12 hover:scale-105 transition-transform duration-300'>
