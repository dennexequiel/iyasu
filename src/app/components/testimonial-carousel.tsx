      ...
      <div ref={emblaRef}>
        ...
        <div className='flex -mx-2 lg:-mx-4'>
          {testimonials.map((testimonial) => (
            <div
              key={testimonial.id}
              className='flex-[0_0_90%] sm:flex-[0_0_30%] lg:flex-[0_0_25%] px-2 lg:px-4'
            >
              {/* Card */}
              <motion.div
                className='bg-white p-8 h-auto min-w-[300px] max-w-full sm:max-w-[90%] lg:max-w-[500px] rounded-[32px] shadow-lg mx-auto'
