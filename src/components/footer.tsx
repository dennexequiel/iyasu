  ...
  return (
    <footer className='bg-white py-8 px-4 md:px-8'>
      <div className='container mx-auto flex flex-col md:flex-row justify-between items-start'>
        {/* First Column: Logo, Email, Address */}
        <div className='flex flex-col md:flex-row w-full md:w-auto space-y-6 md:space-y-0 md:space-x-8'>
          ...
          <div className='text-left'>
            ...
            <a href='mailto:hello@iyasu.life' className='hover:underline'>
              hello@iyasu.life
            </a>
          </div>
        ...
        {/* Second Column: Social Icons and Copyright */}
        <div className='flex flex-col md:items-end w-full md:w-auto mt-6 md:mt-0'>
          ...
          <div className='flex space-x-4 justify-start md:justify-end mb-4'>
            <a
              href='https://www.facebook.com/iyasulife/'
              target='_blank'
            ...
            <a
              href='https://www.instagram.com/iyasu.life/'
              target='_blank'
              rel='noopener noreferrer'
            ...
            <a
              href='https://www.tiktok.com/@iyasu.life'
              target='_blank'
              rel='noopener noreferrer'
              aria-label='TikTok'
            >
